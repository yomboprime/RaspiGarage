...
function startTelegram( botTokenParam, privateChatIdParam, parseUserInput, translationParam, onStarted ) {
...
function setTranslation( translationParam ) {
